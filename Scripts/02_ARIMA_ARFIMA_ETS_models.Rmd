...
### Here, we apply ARIMA, ETS and ARFIMA models for the first wikipedia page - 2NE1_zh.wikipedia.org
...
page_2NE1_views_train1 <- ts(page_2NE1_views_train1,frequency = 1)
page_2NE1_views_test1 <- ts(page_2NE1_views_test1,frequency = 1)
